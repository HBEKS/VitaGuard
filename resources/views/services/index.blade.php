            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="create_service_name" class="form-control" placeholder="Service name">
                    </div>
                    <div class="mb-3">
                        <label>Description</label>
                        <textarea id="create_description" class="form-control" placeholder="Description"></textarea>
                    </div>
                    <div class="mb-3">
                        <label>Availability</label>
                        <input type="text" id="create_availability" class="form-control" placeholder="e.g. 08.00 - 17.00">
                    </div>
                    <div class="mb-3">
                        <label>Price</label>
                        <input type="number" id="create_price" class="form-control" placeholder="0">
                    </div>
                    <div class="mb-3">
                        <label>Category</label>
                        <select id="create_category_id" class="form-select">
...
function storeData() {
    $.ajax({
        type: 'POST',
        url: '{{ route("services.storeData") }}',
        data: {
            '_token': '<?php echo csrf_token(); ?>',
            'service_name': $('#create_service_name').val(),
            'description':  $('#create_description').val(),
            'availability': $('#create_availability').val(),
